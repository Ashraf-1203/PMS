...
const IssuedPaperPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setSuccess('');
        try {
            await inventoryService.issuePaper({
            ...
            setSuccess(`Successfully issued ${quantityRm} RM of paper. Stock has been updated.`);
            // Clear form
            setSelectedPaper('');
            setSelectedMachine('');
            setJpcNumber('');
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Issue Paper</h1>
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="quantityRm" className="block text-sm font-medium text-gray-700">Quantity to Issue (RM)</label>
...
export default IssuedPaperPage;
